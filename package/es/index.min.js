(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("store-es", [], factory);
	else if(typeof exports === 'object')
		exports["store-es"] = factory();
	else
		root["store-es"] = factory();
...
var checker = function checker(elem) {
  ...
  if (type === "dom") {
    return (typeof elem === "undefined" ? "undefined" : __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_typeof___default()(elem)) === "object" && elem.nodeType === 1 && typeof elem.nodeName === "string";
  } else if (type === "document") {
    return (typeof elem === "undefined" ? "undefined" : __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_typeof___default()(elem)) === "object" && elem.nodeType === 9 && elem.nodeName === "#document";
  } else if (type === "window") {
 ...
 */
var checker = function checker(date) {
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__checker__ = __webpack_require__(46);
 ...
 */
var formater = function formater(date, fmt) {
...
sorter.quicker.with = function () {
  ...
  for (var n = 1; n < array.length; n++) {
    var element = array[n];
    var res = callback.call(context, element, mid, array);
...
sorter.subbinger = function () {
  ...
  for (var n = 0; n < len - 1; n++) {
    for (var k = 0; k < len - n - 1; k++) {
      if (isUp && array[k] > array[k + 1] || !isUp && array[k] < array[k + 1]) {
        var _ref = [array[k + 1], array[k]];
        array[k] = _ref[0];
        array[k + 1] = _ref[1];
      }
    }
 ...
 * @return [ boolean ]
 */
var baser = function baser(string) {
...
baser.size = function (base64) {
  ...
  var index2 = base64.indexOf("=");
  var base = base64.slice(index1 + 1, index2 > -1 ? index2 : base64.length);
  var strLength = base.length;
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_number_is_integer__ = __webpack_require__(4);
 ...
 * unit 单位
 */
var formater = function formater(size) {
  if (!__WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_number_is_integer___default()(size) || size < 0) {
    throw new Error("The argument must be int number and must be not less than 0.");
  }
  var storage = [{ unit: "B", scaler: 1 }, { unit: "KB", scaler: 1024 }, { unit: "MB", scaler: 1024 * 1024 }, { unit: "GB", scaler: 1024 * 1024 * 1024 }, { unit: "TB", scaler: 1024 * 1024 * 1024 * 1024 }];
  var res = {
    value: 0,
    unit: ""
  };
  for (var n = storage.length - 1; n > -1; n--) {
    var value = Math.round(size / storage[n]["scaler"]);
    if (value > 0) {
      res.value = value;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__arrayer_index_js__ = __webpack_require__(86);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__dater_index_js__ = __webpack_require__(122);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__typer_index_js__ = __webpack_require__(125);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__objecter_index_js__ = __webpack_require__(130);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__domer_index_js__ = __webpack_require__(136);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__stringer_index_js__ = __webpack_require__(153);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__funer_index_js__ = __webpack_require__(166);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__number_index_js__ = __webpack_require__(175);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__regexer_index_js__ = __webpack_require__(78);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__langer_index_js__ = __webpack_require__(178);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__imager_index_js__ = __webpack_require__(183);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__storager_index_js__ = __webpack_require__(196);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__hexer_index_js__ = __webpack_require__(199);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__urler_index_js__ = __webpack_require__(200);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__queryer_index_js__ = __webpack_require__(201);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__checker_index_js__ = __webpack_require__(202);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__event_emeitter_index_js__ = __webpack_require__(203);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__calcer_index_js__ = __webpack_require__(210);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__delayer__ = __webpack_require__(87);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__dimener__ = __webpack_require__(63);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__flattener__ = __webpack_require__(97);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__shuffler__ = __webpack_require__(98);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__sorter__ = __webpack_require__(64);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__templater__ = __webpack_require__(99);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__timeser__ = __webpack_require__(103);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__transposer__ = __webpack_require__(106);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__treer__ = __webpack_require__(107);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__trulyer__ = __webpack_require__(108);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__uniquer__ = __webpack_require__(109);
...
function delayer(array) {
  ...
  array.forEach(function (item) {
    ...
    newArray.push(item);
    if (children) {
      newArray.push.apply(newArray, __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_toConsumableArray___default()(delayer(children)));
    }
  });
  return newArray;
}
...
function flattener(array) {
  var deepth = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 1;
  ...
  for (var n = 0; n < array.length; n++) {
    if (deepth > 1) {
      if (!Array.isArray(array[n])) {
        ...
        arr.push.apply(arr, __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_toConsumableArray___default()(flattener(array[n], --deepth)));
      }
    } else {
      arr.push(array[n]);
    }
...
function templater() {
  ...
  if (!__WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_number_is_integer___default()(start)) {
    throw new Error("The first argument must be integer number.");
  }
  if (!__WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_number_is_integer___default()(len) || len <= 0) {
  ...
  var res = [];
  if (isUp) {
    for (var n = start; n < len + start; n++) {
      res.push(n);
    }
  } else {
    for (var _n = start; _n > start - len; _n--) {
      res.push(_n);
    }
  }
  return res;
 ...
 * @return: [ array<number>]
 */
templater.stringer = function () {
  var len = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 10;
  var charLen = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 4;

  if (!__WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_number_is_integer___default()(len) || len <= 0) {
    throw new Error("The first argument must be integer number and it must be greater than 0,and this normal is 10.");
  }
  if (!__WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_number_is_integer___default()(charLen) || charLen < 1) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_number_is_nan__ = __webpack_require__(65);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__sorter__ = __webpack_require__(64);
...
function timeser() {
  ...
  var _loop = function _loop(n) {
    var element = array[n];
    var index = ret.findIndex(function (item) {
      var nan = __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_number_is_nan___default()(item['value']) && __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_number_is_nan___default()(element);
...
timeser.maxer = function () {
  ...
  var ret = times(array);
  var sortRet = __WEBPACK_IMPORTED_MODULE_1__sorter__["a" /* default */].quicker.with(ret, function (prev, next) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__dimener__ = __webpack_require__(63);


// 判断数组子元素的长度是否一致
var equalLen = function equalLen(arr) {
...
function transposer(array) {
  ...
  for (var n = 0; n < array.length; n++) {
    for (var _k = 0; _k < array[n].length; _k++) {
      resArr[_k][n] = array[n][_k];
    }
  }
  return resArr;
}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_set__ = __webpack_require__(110);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_toConsumableArray__ = __webpack_require__(12);
...
function uniquer(array) {
  ...
  return [].concat(__WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_toConsumableArray___default()(new __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_set___default.a(array)));
}
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__checker__ = __webpack_require__(46);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__formater__ = __webpack_require__(47);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__reverser__ = __webpack_require__(123);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__zer__ = __webpack_require__(124);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_number_is_integer__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_number_is_integer___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_number_is_integer__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__checker__ = __webpack_require__(46);
...
var reverser = function reverser(createTime, currentTime, backTimeRange) {
  var type = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : "day";

  if (!Object(__WEBPACK_IMPORTED_MODULE_1__checker__["a" /* default */])(createTime)) throw new Error("The first argument must be a valid date.");
  if (!Object(__WEBPACK_IMPORTED_MODULE_1__checker__["a" /* default */])(currentTime)) throw new Error("The second argument must be a valid date.");
  if (!__WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_number_is_integer___default()(backTimeRange) || backTimeRange < 0) throw new Error("The third argument must be int number,and it must be not less than 0.");
  var types = ["day", "hour", "minute", "second"];
  if (types.findIndex(function (item) {
    return item === type;
  }) === -1) throw new Error("The fourth argument must be in ['day', 'hour', 'minute', 'second'].");
  ...
  var backTime = createTime + backTimeRange - currentTime;
  var storage = void 0;
  if (type === "day") {
...
function zer(value) {
  if (__WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_number_is_integer___default()(value) || value < 0) throw new Error("The argument must be int number , and it must be not less than 0.");
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__browser__ = __webpack_require__(126);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__ios__ = __webpack_require__(127);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__is__ = __webpack_require__(74);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__orientation__ = __webpack_require__(128);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__checker__ = __webpack_require__(131);
...
checker.emptyer = function (object) {
  ...
  return __WEBPACK_IMPORTED_MODULE_1_babel_runtime_core_js_object_keys___default()(object).length === 0;
};
...
checker.plainer = function (object) {
  try {
    ...
    while (__WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_object_get_prototype_of___default()(proto) !== null) {
      proto = __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_object_get_prototype_of___default()(proto);
    }
    //console.log(Object.getPrototypeOf(null));
    return __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_object_get_prototype_of___default()(object) === proto; // 指向同一个object原型对象
  } catch (error) {
    return false;
  }
};
...
checker.freer = function (object) {
  ...
  return __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_object_get_prototype_of___default()(object) === null || __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_object_get_prototype_of___default()(__WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_object_get_prototype_of___default()(object)) === null;
};
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__classer__ = __webpack_require__(137);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__checker__ = __webpack_require__(31);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__heighter__ = __webpack_require__(149);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__listener__ = __webpack_require__(150);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__queryer__ = __webpack_require__(151);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__scroller__ = __webpack_require__(152);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__checker__ = __webpack_require__(31);
 ...
 * @return [ array ]
 */
var classer = function classer(elem) {
...
classer.haser = function (elem, className) {
  ...
  return classer(elem).findIndex(function (item) {
...
classer.adder = function (elem, className) {
  ...
  if ("classList" in elem) {
    ...
    var prevClassName = classer(elem);
    var findIndex = prevClassName.findIndex(function (item) {
      return item === className;
    });
    if (findIndex === -1) {
...
classer.remover = function (elem, className) {
  ...
  if ("classList" in elem) {
    ...
    var prevClassName = classer(elem).filter(function (item) {
      return item !== className;
    });
    elem.setAttribute("class", prevClassName.join(" "));
  }
 ...
 * @return [ number ]
 */
var heighter = function heighter(element) {
 ...
 * @return [ element ]
 */
var queryer = function queryer(selector) {
  ...
  if (["class", "id", "tag"].findIndex(function (item) {
    return item === type;
  }) === -1) throw new Error("The second argument must be in ['class', 'id', 'tag'].");
  if (type === "class") {
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__check__ = __webpack_require__(154);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__connect__ = __webpack_require__(155);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__contains__ = __webpack_require__(156);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__convert__ = __webpack_require__(157);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__hump__ = __webpack_require__(158);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__insert__ = __webpack_require__(159);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__path__ = __webpack_require__(160);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__random__ = __webpack_require__(161);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__reverse__ = __webpack_require__(162);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__shousand__ = __webpack_require__(163);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__transfer__ = __webpack_require__(164);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__trim__ = __webpack_require__(165);
...
check.center = function (string, target) {
  ...
  var index = (string.length - target.length) / 2;
  if (!__WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_number_is_integer___default()(index)) return false;
...
function connect(string) {
  var connect = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '-';
  var len = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 4;
  var type = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 'start';
  ...
  if (!__WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_number_is_integer___default()(len) || len < 1) {
    throw new Error('The third argument must be int number and it must not less then 1.');
  }
  if (['start', 'end'].findIndex(function (item) {
    return item === type;
  }) === -1) {
  ...
  if (type === 'start') {
    ...
    var _strings = string.split('').reverse();
    var _newStrings = [];
    for (var _n = 0; _n < _strings.length; _n++) {
      if (_n > 0 && _n % len === 0) {
        _newStrings.push(connect);
      }
      _newStrings.push(_strings[_n]);
    }
    return _newStrings.reverse().join('');
  }
}

connect.start = function (string, link, len) {
  return connect(string, link, len, 'start');
};
connect.end = function (string, link, len) {
  return connect(string, link, len, 'end');
};
...
contains.with = function (string, regexp) {
  ...
  var res = [];
  var newRegex = new RegExp(regexp);
  string.replace(newRegex, function () {
    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }
    ...
    res.push({
      ...
      match: [].concat(__WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_toConsumableArray___default()(args.slice(1, -2)))
    });
  });
  return res;
};
...
function convert(string) {
  ...
  var types = ['upper', 'lower', 'upperStart', 'lowerStart', 'exchange'];
...
convert.upper = function (string) {
  return convert(string, 'upper');
};
convert.lower = function (string) {
  return convert(string, 'lower');
};
convert.upperStart = function (string) {
  return convert(string, 'upperStart');
};
convert.lowerStart = function (string) {
  return convert(string, 'lowerStart');
};
convert.exchange = function (string) {
  return convert(string, 'exchange');
};
...
function insert(string) {
  ...
  if (!__WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_number_is_integer___default()(index) || index < 0 || index > string.length) {
...
function path(string) {
  ...
  var regex = new RegExp(/\[(.*?)\]/, "g"); // '.'匹配除换行符外的任意字符
...
function trim(string) {
  var type = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'whole';

  var types = ['start', 'end', 'both', 'whole'];
...
trim.both = function (string) {
  return trim(string, 'both');
};
trim.whole = function (string) {
  return trim(string, 'whole');
};
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__beforer__ = __webpack_require__(167);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__binder__ = __webpack_require__(168);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__curryer__ = __webpack_require__(169);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__debouncer__ = __webpack_require__(170);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__delayer__ = __webpack_require__(171);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__partialer__ = __webpack_require__(172);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__throttler__ = __webpack_require__(173);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__uncurryer__ = __webpack_require__(174);
...
function curryer(fn) {
  ...
  return function () {
    if (arguments.length === 0) {
      var _args = params.concat();
      params = [];
      return fn.call.apply(fn, [this].concat(__WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_toConsumableArray___default()(_args)));
    } else {
      var _params;

      (_params = params).push.apply(_params, arguments);
      return curryer.call.apply(curryer, [this, fn].concat(__WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_toConsumableArray___default()(params)));
    }
  };
}
...
function debouncer(fn, delay) {
  if (typeof fn !== "function") throw new Error("The first argument must be function.");
  if (!__WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_number_is_integer___default()(delay) || delay < 0) throw new Error("The second argument must be int number , and it must be not less than 0.");
  var timeout = null;
  var time = 0;
  return function () {
    var _this = this;
...
function delayer(fn, wait) {
  for (var _len = arguments.length, args = Array(_len > 2 ? _len - 2 : 0), _key = 2; _key < _len; _key++) {
    args[_key - 2] = arguments[_key];
  }

  if (typeof fn !== "function") throw new Error("The first argument must be function.");
  if (!__WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_number_is_integer___default()(wait) || wait < 0) throw new Error("The second argument must be int number , and it must be not less than 0.");
  return function () {
    setTimeout.apply(undefined, [fn, wait].concat(args));
  };
}
...
function partialer(fn) {
  ...
  return function () {
    ...
    return fn.apply(this, [].concat(args, rest));
  };
}
 ...
 * @return [ function ]
 */
var throttler = function throttler(fn, delay) {
  var type = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : "timeout";

  if (typeof fn !== "function") throw new Error("The first argument must be function.");
  if (!__WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_number_is_integer___default()(delay) || delay < 0) throw new Error("The second argument must be int number , and it must be not less than 0.");
  if (["timeout", "time"].findIndex(function (item) {
    return item === type;
  }) === -1) throw new Error("The third argument must be in ['timeout', 'time'].");
  if (type === "timeout") {
    var timeout = null;
    var time = 0;
    return function () {
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__changeToChineseUpper__ = __webpack_require__(176);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__changeToChinese__ = __webpack_require__(177);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__cloner__ = __webpack_require__(179);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__equaler__ = __webpack_require__(180);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__caser__ = __webpack_require__(181);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__getter__ = __webpack_require__(182);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_babel_runtime_core_js_object_keys__ = __webpack_require__(30);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_babel_runtime_core_js_object_keys___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_babel_runtime_core_js_object_keys__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_babel_runtime_core_js_object_get_prototype_of__ = __webpack_require__(48);
...
function freer(object) {
  //当object是undefined，null 会报错： Cannot convert undefined or null to object
  if (object == null) return false;
  return __WEBPACK_IMPORTED_MODULE_2_babel_runtime_core_js_object_get_prototype_of___default()(object) === null || __WEBPACK_IMPORTED_MODULE_2_babel_runtime_core_js_object_get_prototype_of___default()(__WEBPACK_IMPORTED_MODULE_2_babel_runtime_core_js_object_get_prototype_of___default()(object)) === null;
}
// 检查是否在指定的类型当中
function checker(type) {
  var method = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'support';
...
cloner.nexter = function (prev, next) {
  var prevType = typer(prev);
  var nextType = typer(next);
  ...
  if (prevType === 'object') {
    var prevKeys = __WEBPACK_IMPORTED_MODULE_1_babel_runtime_core_js_object_keys___default()(prev);
    var nextKeys = __WEBPACK_IMPORTED_MODULE_1_babel_runtime_core_js_object_keys___default()(next);
    var mergeKeys = [].concat(__WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_toConsumableArray___default()(prevKeys), __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_toConsumableArray___default()(nextKeys)).filter(function (item, index, array) {
      return array.indexOf(item) === index;
    });
    var _res2 = {};
    mergeKeys.forEach(function (item) {
      _res2[item] = cloner.nexter(prev[item], next[item]);
    });
    return _res2;
  }
};
...
cloner.prever = function (prev, next) {
  ...
  if (prevType === 'object') {
    var prevKeys = __WEBPACK_IMPORTED_MODULE_1_babel_runtime_core_js_object_keys___default()(prev);
    var _res3 = {};
    prevKeys.forEach(function (item) {
      _res3[item] = cloner.prever(prev[item], next[item]);
    });
    return _res3;
  }
};
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_babel_runtime_core_js_number_is_nan__ = __webpack_require__(65);
...
function equaler(prev, next) {
  ...
  if (prevType === 'number') return prev === next || __WEBPACK_IMPORTED_MODULE_1_babel_runtime_core_js_number_is_nan___default()(prev) && __WEBPACK_IMPORTED_MODULE_1_babel_runtime_core_js_number_is_nan___default()(next);
  if (prevType === 'object') {
    var prevKeys = __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_object_keys___default()(prev);
    var nextKeys = __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_object_keys___default()(next);
    if (prevKeys.length !== nextKeys.length) return false;
    for (var n = 0; n < prevKeys.length; n++) {
      var isCheck = equaler(prev[prevKeys[n]], next[prevKeys[n]]);
      if (!isCheck) {
        return false;
      }
    }
  ...
  if (prevType === 'array') {
    ...
    for (var _n = 0; _n < prev.length; _n++) {
      var _isCheck = equaler(prev[_n], next[_n]);
      if (!_isCheck) {
        return false;
      }
    }
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__baser__ = __webpack_require__(79);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__compresser__ = __webpack_require__(184);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__filer__ = __webpack_require__(192);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__formater__ = __webpack_require__(84);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__sizer__ = __webpack_require__(193);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__transformer__ = __webpack_require__(194);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__typer__ = __webpack_require__(195);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__baser__ = __webpack_require__(79);
 ...
 */
compressser.qualityer = function (src) {
 ...
 * @return [ promise ] => [ string<base64>]
 */
compressser.widther = function (src, width) {
  var type = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : "image/png";
 ...
 * @return  [ promise ] => [ string<base64>]
 */
compressser.heighter = function (src, height) {
  var type = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : "image/png";
 ...
 * @msg  图片会被挤压
 */
compressser.sizer = function (src, width, height) {
  var type = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : "image/png";
 ...
 * @return  [ promise ] => [ string<base64>]
 */
compressser.ratioer = function (src) {
 ...
 * @return [ promise ] => [ string<base64>]
 */
compressser.valumer = function (src) {
  var size = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 200 * 1024;
  var range = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 100;
  var type = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : "image/png";
      ...
      image.onload = function () {
        try {
          ...
          do {
            ...
            resSize = __WEBPACK_IMPORTED_MODULE_1__baser__["a" /* default */].size(res);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_promise__ = __webpack_require__(16);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_promise___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_promise__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__typer_is__ = __webpack_require__(74);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__dater_formater__ = __webpack_require__(47);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__formater__ = __webpack_require__(84);




var isFile = Object(__WEBPACK_IMPORTED_MODULE_1__typer_is__["a" /* default */])("file");
...
var filer = function filer(file) {
  if (!isFile(file)) {
    throw new Error("The argument must be file.");
  }
  var lastUpdateDate = Object(__WEBPACK_IMPORTED_MODULE_2__dater_formater__["a" /* default */])(file.lastModified, "yyyy-MM-dd HH:mm:ss");
  var transformSize = Object(__WEBPACK_IMPORTED_MODULE_3__formater__["a" /* default */])(file.size);
  var types = file.type.split("/");
  var name = file.name;
  var nameSlotIndex = file.name.lastIndexOf(".");
  return {
    type: types[0],
    subType: types[1],
...
filer.baser = function (file) {
  ...
  return new __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_promise___default.a(function (resole, reject) {
    setTimeout(function () {
      try {
 ...
 */
var sizer = function sizer(src) {
  var type = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : "height-width";

  if (typeof src !== "string") throw new Error("The argument must be string.");
  if (["height-width", "height", "width", "volume"].findIndex(function (item) {
    return item === type;
  }) === -1) throw new Error("The second argument must be in ['height-width', 'height', 'width','volume'].");
  if (type === "volume") {
    return new __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_promise___default.a(function (resolve, reject) {
      var xmlhttp = void 0;
...
var transformer = function transformer(src) {
  ...
  if (["base64", "blob"].findIndex(function (item) {
    return item === type;
  }) === -1) throw new Error("The third argument must be in ['base64', 'blob' ].");
  return new __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_promise___default.a(function (resolve, reject) {
    setTimeout(function () {
      var image = new Image();
      image.src = src;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_json_stringify__ = __webpack_require__(197);
  ...
  return new __WEBPACK_IMPORTED_MODULE_1_babel_runtime_core_js_promise___default.a(function (resolve, reject) {
    setTimeout(function () {
      try {
        ...
        var storeFormat = store ? JSON.parse(store) : undefined;
...
Storager.prototype.setter = function (key, value) {
  ...
  return new __WEBPACK_IMPORTED_MODULE_1_babel_runtime_core_js_promise___default.a(function (resolve, reject) {
    setTimeout(function () {
      try {
        var result = {};
        result.time = Object(__WEBPACK_IMPORTED_MODULE_2__dater_formater__["a" /* default */])(new Date(), 'yyyy-MM-dd HH:mm:ss');
        result.path = window.location.href;
        result.type = Object.prototype.toString.call(value).slice(8, -1).toLowerCase();
        result.value = value;
        _this2.storage.setItem(key, __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_json_stringify___default()(result));
        resolve(value);
      } catch (e) {
        reject(e);
      }
 ...
 * @return [ string ]
 */
Hexer.prototype.encodeURI = function (string) {
  var concat = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : ',';
  ...
  var val = '';
  for (var i = 0; i < string.length; i++) {
    if (val == '') val = string.charCodeAt(i).toString(16);else val += concat + string.charCodeAt(i).toString(16);
  }
  return val;
};
...
Hexer.prototype.decodeURI = function (string) {
  var concat = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : ',';
...
Hexer.prototype.decodeComponent = function (string) {
  ...
  for (var i = 0; i < string.length; i += 2) {
    var code = string.substring(i, i + 2);
...
Query.prototype.encode = function (string) {
  return encodeURIComponent(string).replace(encodeReserveRE, encodeReserveReplacer).replace(commaRE, ",");
};
...
Query.prototype.stringify = function stringify(obj) {
  ...
  var res = obj ? __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_object_keys___default()(obj).map(function (key) {
    var val = obj[key];
    ...
    if (Array.isArray(val)) {
      ...
      val.forEach(function (val2) {
        ...
        if (val2 === null) {
          result.push(_this.encode(key));
        } else {
          result.push(_this.encode(key) + "=" + _this.encode(val2));
        }
      });
      return result.join("&");
    }

    return _this.encode(key) + "=" + _this.encode(val);
  }).filter(function (x) {
    return x.length > 0;
  }).join("&") : null;
  return res ? "?" + res : "";
...
Query.prototype.parse = function parse(query) {
  ...
  query.split("&").forEach(function (param) {
    ...
    var key = _this2.decode(parts.shift());
    var val = parts.length > 0 ? _this2.decode(parts.join("=")) : null;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_number_is_integer__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_number_is_integer___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_number_is_integer__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__regexer__ = __webpack_require__(78);
 ...
 * @return [ object ] 当前实例
 */
Check.prototype.set = function (data) {
...
Check.prototype.minLen = function (message, min) {
  ...
  if (!__WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_number_is_integer___default()(min) || min < 0) {
    throw new Error("The second argument must be int number,and it's must be not less than 0.");
  }
  if (!this.pass || !this.isRequire && !this._isRequire(this.data)) {
    return this;
...
Check.prototype.maxLen = function (message, max) {
  ...
  if (!__WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_number_is_integer___default()(max) || max < 1) {
    throw new Error("The second argument must be int number,and it's must be greater than 0.");
  }
  if (!this.pass || !this.isRequire && !this._isRequire(this.data)) {
    return this;
  }
  var regex = new RegExp("^[\\s\\S]{0," + max + "}$");
  this.pass = regex.test(this.data);
  if (!this.pass) {
    this.message = message;
  }
...
Check.prototype.rangeLen = function (message, min, max) {
  ...
  if (!__WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_number_is_integer___default()(min) || !__WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_number_is_integer___default()(max)) {
  ...
  var regex = new RegExp("^[\\s\\S]{" + min + "," + max + "}$");
  this.pass = regex.test(this.data);
  if (!this.pass) {
    this.message = message;
  }
...
Check.prototype.regex = function (message, type) {
  ...
  var regex = __WEBPACK_IMPORTED_MODULE_1__regexer__["a" /* default */].findIndex(function (reg) {
    return reg.type === type;
  });
  if (regex === -1) {
    throw new Error("The regex type is undefined.");
  }
  this.pass = __WEBPACK_IMPORTED_MODULE_1__regexer__["a" /* default */][regex]["value"].test(this.data);
  if (!this.pass) {
    this.message = message;
  }
  return this;
...
Check.prototype.check = function (message, callback) {
  ...
  this.pass = callback.call(this, this.data, __WEBPACK_IMPORTED_MODULE_1__regexer__["a" /* default */]);
  if (!this.pass) {
    this.message = message;
  }
  return this;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_map__ = __webpack_require__(204);
...
function EventEmeitter() {
  this.events = new __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_map___default.a();
}
/**
 * @name: 监听名为type的事件
 * @param { type } [ string ]
...
EventEmeitter.prototype.emit = function (type) {
  ...
  if (Array.isArray(handler)) {
    handler.forEach(function (handlerItem) {
      handlerItem.call.apply(handlerItem, [_this].concat(args));
    });
 ...
 */
//
Calcer.prototype._template = function () {
  var len = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 10;
  var callback = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : function () {};
  var context = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : this;
...
Calcer.prototype._insert = function (string) {
  var index = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0;
  var target = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : '';
...
Calcer.prototype._isFreeNumber = function (string) {
  ...
  var regex = /(^[0](\.[0-9]+)?$)|(^[1-9]([0-9]+)?(\.[0-9]+)?$)/; ///(^0\.([0-9]*)?[1-9]+([0-9]*)?$)|(^[0]{1}$)|(^[1-9]([0-9]+)?(\.[0-9]+)?$)/;
  return regex.test(string);
};
...
Calcer.prototype.adder = function (prev, next) {
  ...
  // 进行整数部分0的补位
  var intZero = this._template(Math.abs(minusIntLen), function () {
    return '0';
  }).join('');
  if (minusIntLen > 0) {
    next = intZero + next;
  ...
  // 进行浮点数部分0的补位
  var floatZero = this._template(Math.abs(minusFloatLen), function () {
    return '0';
  }).join('');
  if (minusFloatLen > 0) {
    next = next + floatZero;
  ...
  for (var i = 0; i < prev.length; i++) {
    var addRes = Number(prev[i] || 0) + Number(next[i] || 0) + Number(resArr[i] || 0);
    resArr[i] = addRes % 10;
    var _res = (addRes - addRes % 10) / 10;
    _res > 0 ? resArr[i + 1] = _res : null;
  }
  var res = resArr.reverse().join('');
  var resSlot = this._insert(res, res.length - maxFloatLen, '.');
...
Calcer.prototype.muler = function (prev, next) {
  ...
  next = next.replace('.', '');
  var res = [];
  for (var n = prev.length - 1; n >= 0; n--) {
    for (var k = next.length - 1; k >= 0; k--) {
      var value = Number(prev[n] || 0) * Number(next[k] || 0) + (res[n + k + 1] || 0);

      var value1 = value % 10;
      var value2 = (value - value1) / 10;
      res[n + k + 1] = value1;
      res[n + k] = value2 + Number(res[n + k] || 0);
    }
  }
  var resJoin = res.join('');
  var resInsert = this._insert(resJoin, resJoin.length - addFloatLen, '.');
  var resFormat = this._format(resInsert);
  return resFormat;
};
