...
const orderStatusTypes = [
  { value: 0, text: "已取消", className: "is-color--danger", icon: "&#xe61e;" },
  {
    value: 1,
    text: "等待付款",
  ...
  { value: 3, text: "已完成", className: "is-color--success", icon: "&#xe742;" }
];
...
let getDrawTypes = (target, type) => getTypes(drawTypes, target, type);
