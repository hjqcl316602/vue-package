...
export default {
    ...
    methods: {
        ...
        getOrderMessage(loading=false){
            getOrderMessage({
                accessToken: this.params.accessToken
            },{ loading :  loading , loadingLeastTime : 500 }).then(( { data ,code ,msg })=>{
                if( code === '000'){
    ...
    <div class=" ">
      ...
      <template v-if="params.payMode">
        <div
          ...
          style="line-height: 36px"
        >
          <span class="vi-text is-color--light">提现方式</span>
      ...
      <template v-if="params.createTime">
        <div
          ...
          style="line-height: 36px"
        >
          <span class="vi-text is-color--light">申请时间</span>
      ...
      <template v-if="params.payTime">
        <div
          ...
          style="line-height: 36px"
        >
          <span class="vi-text is-color--light">到账时间</span>
