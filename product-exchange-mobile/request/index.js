...
export let getAccountFix = params =>
  axios.post(config.http + "/uc/approve/payCode/list", params);
 ...
 * }
 */
export let delAccountFix = params =>
  axios.post(config.http + "/uc/approve/payCode/delete", params);
 ...
 * }
 */
export let getAccountRemark = params =>
  axios.post(config.http + "/uc/approve/payCode/remark", params);
 ...
 * }
 */
export let createAccountFix = params =>
  axios.post(config.http + "/uc/approve/payCode/insert", params);
